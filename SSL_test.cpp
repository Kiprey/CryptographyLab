...
static SSL_CTX * SSL_init(const string& ca_crt_path, const string& crt_path, const string& key_path) {
    // 准备好打印调试信息
...
int main(int argc, char *argv[])
{
    ...
    if (argc == 2)
    {
        ...
        SSL_CTX* ctx = SSL_init(ca_path, cer_path, key_path);
